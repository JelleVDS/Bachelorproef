...
def simulate_radius(t_end, Par, q0, Nz = 14**2, Ny = 14**2, methode = 'BDF'):
    """
...
def wormhole_with_symmetry(t_end=2000, q0 = [96.75, np.pi, np.pi/2], Nz=1024, Ny=2048, Par=[0.43/1.42953, 8.6, 4.3], h = 0.001, choice=True):
    """
